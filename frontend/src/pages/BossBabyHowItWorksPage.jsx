...
const steps = [
  ...
  },
  {
    ...
    body: "Answer a few quick questions: your age, weight, activity level, where you're based. This helps the algorithm get to know you so your formula is created around your actual body, not some random average.",
    note: null,
    photoSrc: step2,
    flip: true,
    accent: "#fff",
