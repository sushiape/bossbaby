...
  // Die React-State-Logik (useState, handleSubmit) wird nicht mehr benötigt,
  // da Formspree das Formular-Handling übernimmt.
...
          
          {/* Das <form>-Tag zeigt jetzt auf deinen Formspree Endpoint */}
          <form 
            action="https://formspree.io/f/wblgroob" 
            method="POST" 
            className="flex flex-col gap-4 items-center max-w-2xl mx-auto"
          >
            {/* 1. Reihe: E-Mail-Feld und Button */}
            <div className="flex gap-3 justify-center flex-wrap">
              <input
                type="email"
                name="email_address" /* Dies ist der Spaltenname in Formspree */
            ...
            {/* 2. Reihe: DATENSCHUTZ-CHECKBOX (mit korrigiertem Namen) */}
            <div className="flex items-center gap-2 max-w-md mt-2">
              <input
                type="checkbox"
                id="gdpr-consent"
                name="gdpr_consent" /* Dies wird eine Spalte in Formspree */
                value="consented"
                required
              ...
              <label 
                ...
                className="text-xs text-white text-left" /* Kleiner, weißer Text */
              >
                I consent to my email address being stored and used *only* to notify me when **Bossbaby** launches. I understand I can unsubscribe at any time.
              </label>
            </div>
          </form>
        </div>
        {/* ===== ENDE: WAITLIST FORM (ENGLISH) ===== */}
      
      </section>
